...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"music-uni","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!**********************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!**************************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/store/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    ...
    NEXT_ID: function NEXT_ID(state, payload) {
      var index = state.topListIds.findIndex(function (item) {
...
/* 44 */
/*!************************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/until/api.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.searchHotDetail = searchHotDetail;
...
var _apiconfig = __webpack_require__(/*! @/until/apiconfig.js */ 45);
function topList() {
  return new Promise(function (reslove, reject) {
    uni.request({
      url: "".concat(_apiconfig.baseUrl, "/toplist/detail"),
      method: "GET",
...
function playList(id) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/playlist/detail?id=").concat(id),
    method: "GET"
  });
}
...
function songDetail(songId) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/song/detail?ids=").concat(songId),
    method: "GET"
  });
}
...
function songSimi(songId) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/simi/song?id=").concat(songId),
    method: "GET"
  });
}
...
function songComment(songId) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/comment/music?id=").concat(songId),
    method: "GET"
  });
}
...
function songLyric(songId) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/lyric?id=").concat(songId),
    method: "GET"
  });
}
...
function songUrl(songId) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/song/url?id=").concat(songId),
    method: "GET"
  });
}
// /search/hot/detail 热搜列表
function searchHotDetail() {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/search/hot/detail"),
    method: "GET"
  });
}

// /search?keywords=海阔天空  搜索
function searchList(keywords) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/search?keywords=").concat(keywords),
    method: "GET"
  });
}
...
function searchSuggest(keywords) {
  return uni.request({
    url: "".concat(_apiconfig.baseUrl, "/search/suggest?keywords=").concat(keywords, "&type=mobile"),
    method: "GET"
  });
}
...
/* 45 */
/*!******************************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/until/apiconfig.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 52 */
/*!*************************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/static/sq.png ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 53 */
/*!****************************************************************!*\
  !*** D:/毕业设计/毕业设计源码/cloudmusic/music-uni-app/static/dujia.png ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
